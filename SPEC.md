...
| Complete source locations for all semantic errors | Partial: wrapper/unary expression-derived typecheck/lower diagnostics and common compound expression-derived lower diagnostics reuse nested source spans through first source-carrying child fallback; source-facing symbol failures use their declaration span/path; remaining gaps are registry-child and declaration-shape diagnostics without a concrete member span, plus internal/synthetic macro rebuild errors tracked by #4417. |
