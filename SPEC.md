...
| Complete source locations for all semantic errors | Partial: wrapper/unary expression-derived typecheck/lower diagnostics and common compound expression-derived lower diagnostics reuse nested source spans through first source-carrying child fallback; source-facing symbol failures preserve available expression spans and paths; declaration-shape and registry-member diagnostics still lack a concrete member span, as do internal/synthetic macro rebuild errors tracked by #4417. |
