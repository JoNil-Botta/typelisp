...
| Check codegen shape and parity | `verify-asm-shape-gates.sh`, `verify-math-exp-codegen.sh`, `verify-math-log-codegen.sh`, `verify-math-trig-codegen.sh`, `check-codegen-target-parity.sh`, `check-backend-target-asm-parity.sh` |
