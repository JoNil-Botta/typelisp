...
verify_embedded_stdlib_payload() {
    TYPELISP_BIN=$COMPILER scripts/verify-embedded-stdlib-payload.sh
}
...
stdlib/tests/format_exponent_pointer_reject.tl|fail|format: 'e' selector requires an integer or float argument
stdlib/tests/format_exponent_reference_reject.tl|fail|format: 'E' selector requires an integer or float argument
stdlib/tests/format_exponent_string_reject.tl|fail|format: 'e' selector requires an integer or float argument; got String
...
stdlib/tests/format_multibyte_fill_reject.tl|fail|format: fill must be exactly one TypeLisp byte before alignment
...
stdlib/tests/format_width_overflow_reject.tl|fail|format: width integer overflow
...
stdlib/tests/math_exp_non_float_reject.tl|fail|math.exp: expected f64 or f32, found i64
