...
stdlib/tests/io_edges.tl|42|-|-|-|requires-stage0-symbol:file-open-status
stdlib/tests/io_file_handle.tl|42|-|-|-|requires-stage0-symbol:file-open-status
stdlib/tests/io_stdio_lines.tl|42|host-line:stdout-line|host-line:stderr-line|printf:alpha\n\nomega|requires-stage0-symbol:file-open-status
stdlib/tests/io_stdio_bytes.tl|42|-|-|literal:abcdef|requires-stage0-symbol:file-open-status
stdlib/tests/env_api.tl|42|-|-
stdlib/tests/cpu_api.tl|42|-|-|-|requires-stage0-symbol:cpuid
stdlib/tests/fs_api.tl|42|-|-|-|requires-stage0-symbol:file-open-status
...
stdlib/tests/windows_sdk_api.tl|42|-|-|-|requires-stage0-symbol:file-open-status
stdlib/tests/msvc_api.tl|42|-|-|-|requires-stage0-symbol:file-open-status
EOF
}
