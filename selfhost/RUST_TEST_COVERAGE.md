...
Tuple/closure/fixed-array emit-shapes remain split to #1388.
...
- Tuple construction/ref and fixed-array set/ref emit-shape parity have focused
  follow-ups (#1414, #1416). Broader backend-only
