...
compile manifest, and stdlib documentation gate. Package builds route through a
cached selfhost `build.tl` driver, or through a prebuilt
...
REPL/LSP public-tool coverage, and full doc/integration gates still need either
stage1-safe driver linking or dedicated wrapper routing before they can move off
the seed compiler.
