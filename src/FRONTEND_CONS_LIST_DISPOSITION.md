...
| `AstExternLinkInputList` | `src/compiler_ast_types.tl:313` | generated vector family (`ast-extern-link-input-list-*`) | Ordered linker metadata; append/traverse only. | Cold. | `converted-to-generated-vector` | #4186. |
