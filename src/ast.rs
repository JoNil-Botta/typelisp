...
pub enum Expr {
    ...
    /// Lexically scoped arena: `(with-arena r body ...)`. Introduces a region
    ...
    /// expressed by nesting `with-arena` forms. This node only carries the
