...
// ------------------------------------------------------------------
// NOTE (#1071) — Rust inline tests removed for token/span/character
// literal coverage. The original Rust assertions have been migrated to
// TypeLisp-land so they exercise the self-hosted lexer in
// tests/inline/lexer_rust_coverage.tl via the inline-test harness.
// ------------------------------------------------------------------
