...
- `fs.tl`: minimal recoverable filesystem helpers for tool artifact paths,
  ...
  checks, temporary directories, and cleanup. Import it with
  `(import "stdlib/fs.tl")`.
