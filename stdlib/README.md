...
- `fs.tl`: minimal recoverable filesystem helpers for tool artifact paths,
  lexical path normalization, safe relative suffix checks, temporary
  directories, and cleanup. Import it with `(import "stdlib/fs.tl")`.
