...
- `fs.tl`: minimal recoverable filesystem helpers for tool artifact paths,
  current-directory lookup, temporary directories, and cleanup. Import it with
  `(import "stdlib/fs.tl")`.
