...
- `vector.tl`: generated concrete vector family (collections v1, #835/#1989)
  ...
  sequences and keep
  Native `slice-view` / `slice-mut-view`, `array-length`, `array-ref`, and
