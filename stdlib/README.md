...
- `net/http_types.tl`, `net/http_head_codec.tl`, and
  ...
  rules; import it with `(import stdlib.net.http_trailer_policy)`.
...
Run `scripts/verify-embedded-stdlib-payload.sh` to validate all 52 explicit
