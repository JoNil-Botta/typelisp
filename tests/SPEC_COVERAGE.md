...
| S3-011 | 3.7.1 | `comptime-decl` and `comptime-decls` generated declarations, identity, duplicate policy, and allowed payload kinds. | Implemented for current selfhost path | `tests/integration/generated_option_result_families.tl`, `src/tests/compiler_ctfe_smoke.tl`, `src/tests/compiler_typecheck_reflection_smoke.tl` | Partial | #2686 |
