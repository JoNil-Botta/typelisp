...
| S7-004 | 7.3 | Lifetime owner classes and lexical outlives model constrain references, regions, first-class arenas, and atomic arenas. | Lexical references/regions and ordinary first-class arena helpers implemented; `in-arena` and atomic arena slices pending | Reference/arena safety corpus, `src/tests/compiler_typecheck_smoke.tl`, `stdlib/tests/arena_api.tl`, `stdlib/tests/arena_patterns.tl`, `stdlib/tests/arena_policy*.tl` | Partial | #2625, #2642 |
