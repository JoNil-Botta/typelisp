...
| S6-005 | 6.5 | Safe task threading, structural transfer/share classification, safe spawn/join, mutex guards, channels, and atomics. | Partial: raw substrate, concrete `ChannelI64`, and concrete `MutexI64` lexical guards are present; safe structural spawn/transfer and general typed surfaces remain pending | `tests/integration/thread_runtime.tl`, `tests/integration/sync_channel_thread_runtime.tl`, `tests/integration/sync_mutex_thread_runtime.tl`, `stdlib/tests/thread_api.tl`, `stdlib/tests/sync_api.tl`, `tests/safety/sync_mutex_guard_*_reject.tl` cover current raw/std surfaces | Partial | #2714, #2715, #2716, #2717 |
