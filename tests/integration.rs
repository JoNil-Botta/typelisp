...
#[test]
fn tl_compile_smoke_writes_set_program_and_output_exits_42() {
    let (code, stdout, stderr, _asm) = run_compile_smoke_generated_program(
        "tl_compile_smoke_set",
    ...
    assert_eq!(
        code,
        Some(42),
        "tl_compile_smoke set output program exited unexpectedly\nstdout:\n{}\nstderr:\n{}",
        stdout,
        stderr,
    );
    assert_eq!(stdout, "", "tl_compile_smoke set output stdout");
    assert_eq!(stderr, "", "tl_compile_smoke set output stderr");
}

#[test]
fn tl_compile_smoke_writes_set_function_body_and_output_exits_42() {
    let (code, stdout, stderr, _asm) = run_compile_smoke_generated_program(
