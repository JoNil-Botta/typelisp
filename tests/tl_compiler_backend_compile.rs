...
fn compiler_backend_tl_compiles_to_assembly() {
    ...
    for sym in [
        ...
        "_tl_compiler_backend_stack_int_call_ok_question:",
        "_tl_compiler_backend_stack_int_param_ok_question:",
        "_tl_compiler_backend_stack_f64_call_ok_question:",
        "_tl_compiler_backend_target_windows_mixed_stack_abi_ok_question:",
