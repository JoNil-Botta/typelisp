...
fn doc_test_tl_compiles_to_assembly() {
    ...
    for sym in [
        ...
        "_tl_doc_test_parse_run_metadata:",
        "_tl_doc_test_parse_output_spec:",
    ...
    for literal in [
        ...
        "doc-test: runnable smoke mismatch",
        "doc-test: runnable malformed smoke mismatch",
